...
const SendEmail = ({history}) => {
    const {isRequestError, sendMail, message, load} = useContext(DataContext);
    return ( 
        <>
    ...
    >
      {(formik) => {
        ...
        <div className="site-domain">
            <h4 className="text-center text-uppercase">Enthusiatgh</h4>
        </div>
        ...
        <label htmlFor="email">Enter your email</label>
         ...
         <div className="error">{isRequestError && (<p>Something went wrong</p>)}</div>
